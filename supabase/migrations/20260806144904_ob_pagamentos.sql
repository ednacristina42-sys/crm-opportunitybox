-- =====================================================================
-- MIGRATION — Modelo de pagamentos por orçamento (gerada da proposta validada 15bcafe)
-- Ficheiro: supabase/migrations/20260806144904_ob_pagamentos.sql
-- Projeto:  Opportunitybox CRM (ref ddzlbmnmsdyodouqxbjx)
-- Estado:   MIGRATION gerada a partir da proposta validada (commit 15bcafe).
--           NAO aplicada nesta fase (sem db push, sem deploy). Aplicar só com
...
--
-- Decisão operacional Fase 1: apenas utilizadores com role 'admin' vão
-- registar/estornar na prática. A role 'financeiro' MANTÉM-SE no gate para
-- uso futuro; não se criam/alteram utilizadores agora (não é mudança de SQL).
--
